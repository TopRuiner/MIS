...
namespace Polyclinic.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<PolyclinicUser> _userStore;
        private readonly IUserEmailStore<PolyclinicUser> _emailStore;
        ...
        */
        ...
        private PolyclinicUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<PolyclinicUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(PolyclinicUser)}'. " +
                    $"Ensure that '{nameof(PolyclinicUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<PolyclinicUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<PolyclinicUser>)_userStore;
        }
    }
}
